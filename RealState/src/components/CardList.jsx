        ...
        <View style={globalStyles.cardContainer}>
          <View style={globalStyles.leftCard}>
            <View style={globalStyles.imageContainer}>
              ...
              <View style={globalStyles.rating}>
                ...
                <Text style={globalStyles.ratingInnerText}>{rating}</Text>
              </View>
            </View>
          </View>
          ...
          <View style={globalStyles.rightCard}>
            ...
            <View style={globalStyles.innerTextIcons}>
              <Text>
                <FontAwesome name="bed" size={15} color="black" /> {bedrooms}{" "}
              </Text>
              <Text>
                <FontAwesome name="bathtub" size={15} color="black" />{" "}
                {bathrooms}{" "}
              </Text>
              <Text>
                <FontAwesome name="home" size={15} color="black" /> {squareFeet}{" "}
                ft
              </Text>
            </View>
